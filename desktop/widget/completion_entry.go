...
func (c *CompletionEntry) ShowCompletion() {
	...
	if c.navigableList == nil {
		c.navigableList = newNavigableList(c.Options, &c.Entry, c.setTextFromMenu, c.OnMenuNavigation, c.HideCompletion)
	}
...
func newNavigableList(items []string, entry *widget.Entry, setTextFromMenu func(string), navigate func(string), hide func()) *navigableList {
	n := &navigableList{
		entry:           entry,
		selected:        -1,
