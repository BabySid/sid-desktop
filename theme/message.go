...
const (
	...
	AppSodorJobTasksIsRequired               = "Tasks is required"
	AppSodorJobTaskFieldRequiredFormat       = "Task[%d]'s fields are required"
	AppSodorJobRelationsIsRequired           = "Relations is required"
	...
	AppSodorJobInfoAllTaskInstance           = "Task Instances in All Job Instances"
